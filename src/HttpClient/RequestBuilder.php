...
class RequestBuilder
{
    ...
    public function createRaw(string $method, string $uri, array $headers = [], $body = null): RequestInterface
    {
        return $this->createRequest($method, $uri, $headers, $this->getStreamFactory()->createStream($body));
    }
